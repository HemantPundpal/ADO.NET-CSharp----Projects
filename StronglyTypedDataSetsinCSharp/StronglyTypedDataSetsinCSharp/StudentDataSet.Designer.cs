...
namespace StronglyTypedDataSetsinCSharp {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_Students_Emails;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_Students_Emails = this.Relations["FK_Students_Emails"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_Students_Emails = new global::System.Data.DataRelation("FK_Students_Emails", new global::System.Data.DataColumn[] {
                        this.tableStudents.IdColumn}, new global::System.Data.DataColumn[] {
                        this.tableEmails.StudentIdColumn}, false);
            this.Relations.Add(this.relationFK_Students_Emails);
        }
        ...
        public partial class EmailsDataTable : global::System.Data.TypedTableBase<EmailsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmailsRow AddEmailsRow(string Email, StudentsRow parentStudentsRowByFK_Students_Emails) {
                EmailsRow rowEmailsRow = ((EmailsRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        null,
                        Email,
                        null};
                if ((parentStudentsRowByFK_Students_Emails != null)) {
                    columnValuesArray[2] = parentStudentsRowByFK_Students_Emails[0];
                }
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public EmailsRow[] GetEmailsRows() {
                if ((this.Table.ChildRelations["FK_Students_Emails"] == null)) {
                    return new EmailsRow[0];
                }
                else {
                    return ((EmailsRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Students_Emails"])));
                }
            }
        }
        ...
        public partial class EmailsRow : global::System.Data.DataRow {
            ...
            public int StudentId {
                get {
                    return ((int)(this[this.tableEmails.StudentIdColumn]));
                }
                set {
                    this[this.tableEmails.StudentIdColumn] = value;
                }
            }
            ...
            public StudentsRow StudentsRow {
                get {
                    return ((StudentsRow)(this.GetParentRow(this.Table.ParentRelations["FK_Students_Emails"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_Students_Emails"]);
                }
            }
        }
...
namespace StronglyTypedDataSetsinCSharp.StudentDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([FirstName], [LastName]) VALUES (@FirstName, @LastN" +
                "ame)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Students] SET [FirstName] = @FirstName, [LastName] = @LastName WHER" +
                "E (([Id] = @Original_Id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName FROM dbo.Students";
    ...
    public partial class EmailsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Emails] ([Email], [StudentId]) VALUES (@Email, @StudentId)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Emails] SET [Email] = @Email, [StudentId] = @StudentId WHERE (([Id]" +
                " = @Original_Id))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Email, StudentId FROM dbo.Emails";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(StudentDataSet.EmailsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual StudentDataSet.EmailsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentDataSet.EmailsDataTable dataTable = new StudentDataSet.EmailsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentDataSet.EmailsDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Email, int StudentId) {
            if ((Email == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Email, int StudentId, int Original_Id) {
            if ((Email == null)) {
                throw new global::System.ArgumentNullException("Email");
            }
            else {
